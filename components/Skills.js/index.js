...
const Skills = () => (
  <div className="px-4 md:px-[5%] lg:px-[15%] bg-gradient-to-b from-[#FFF] to-[#F0F1FF] grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-x-8 gap-y-[80px] max-md:gap-y-[40px] sm:pt-6 pb-[140px] ">
